---
title: "Sandbox Tools"
description: "Pre-installed security tools in the Mrgana container"
---

Mrgana runs inside a Kali Linux-based Docker container with a comprehensive set of security tools pre-installed. The agent can use any of these tools through the [terminal](/tools/terminal).
