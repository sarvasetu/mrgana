---
title: "Overview"
description: "Configure your AI model for Mrgana"
---

Mrgana uses [LiteLLM](https://docs.litellm.ai/docs/providers) for model compatibility, supporting 100+ LLM providers.
...
```bash
export MRGANA_LLM="ollama/llama4"
...
<CardGroup cols={2}>
  ...
  <Card title="OpenCode Zen" href="/llm-providers/opencode-zen">
    Curated models via OpenCode gateway.
  </Card>
