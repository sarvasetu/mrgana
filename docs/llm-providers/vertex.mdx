...
description: "Configure Mrgana with Gemini models via Google Cloud"
---

## Installation

Vertex AI requires the Google Cloud dependency. Install Mrgana with the vertex extra:

```bash
pipx install "mrgana-agent[vertex]"
```

## Setup

```bash
export MRGANA_LLM="vertex_ai/gemini-3-pro-preview"
```
