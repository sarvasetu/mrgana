---
title: "Azure OpenAI"
description: "Configure Mrgana with OpenAI models via Azure"
---

## Setup

```bash
export MRGANA_LLM="azure/your-gpt5-deployment"
...
|----------|-------------|
| `MRGANA_LLM` | `azure/<your-deployment-name>` |
...
```bash
export MRGANA_LLM="azure/gpt-5.4-deployment"
