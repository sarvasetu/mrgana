---
title: "AWS Bedrock"
description: "Configure Mrgana with models via AWS Bedrock"
---

## Installation

Bedrock requires the AWS SDK dependency. Install Mrgana with the bedrock extra:

```bash
pipx install "mrgana-agent[bedrock]"
```

## Setup

```bash
export MRGANA_LLM="bedrock/anthropic.claude-4-5-sonnet-20251022-v1:0"
```
