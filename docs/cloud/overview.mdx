...
Skip the setup. Run Mrgana in the cloud at [app.mrgana.ai](https://app.mrgana.ai).
...
1. Sign up at [app.mrgana.ai](https://app.mrgana.ai)
2. Connect your repository or enter a target URL
3. Launch your first scan

<Card title="Try Mrgana Cloud" icon="rocket" href="https://app.mrgana.ai">
