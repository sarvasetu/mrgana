...
from mrgana.telemetry._common import (
    SESSION_ID,
    base_props,
    get_version,
    is_first_run,
...
if TYPE_CHECKING:
    from mrgana.report.state import ReportState


logger = logging.getLogger(__name__)

_SCARF_ENDPOINT = "https://mrgana.gateway.scarf.sh"
...
def _send(event: str, properties: dict[str, Any]) -> bool:
    ...
    try:
        ...
        version = str(props.pop("mrgana_version", get_version()) or "unknown")
