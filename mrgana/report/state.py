...
from mrgana.core.paths import run_dir_for
from mrgana.report.sarif import write_sarif
from mrgana.report.usage import LLMUsageLedger
...
class ReportState:
    ...
    persistence. This store keeps only Mrgana-owned scan artifacts and
