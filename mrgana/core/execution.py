"""Execution loop for addressable SDK-backed Mrgana agents."""
...
from mrgana.core.inputs import child_initial_input
from mrgana.core.sessions import (
...
if TYPE_CHECKING:
    ...
    from mrgana.core.agents import AgentCoordinator, Status
...
async def _append_noninteractive_tool_required_message(
    *,
    ...
    message = (
        "Your previous response ended the autonomous Mrgana run without a lifecycle tool call. "
