"""Build SandboxAgents for root + child Mrgana runs."""
...
from mrgana.tools.agents_graph.tools import (
    agent_finish,
    create_agent,
...
from mrgana.tools.finish.tool import finish_scan
from mrgana.tools.load_skill.tool import load_skill
from mrgana.tools.notes.tools import (
    create_note,
    delete_note,
    get_note,
    list_notes,
...
from mrgana.tools.proxy.tools import (
    list_requests,
    list_sitemap,
    repeat_request,
    scope_rules,
...
from mrgana.tools.reporting.tool import create_dependency_report, create_vulnerability_report
from mrgana.tools.thinking.tool import think
from mrgana.tools.todo.tools import (
    create_todo,
    delete_todo,
    list_todos,
    mark_todo_done,
...
from mrgana.tools.web_search.tool import web_search
...
# ``mrgana.runtime.backends.register_backend``: register before the first
# ``build_mrgana_agent`` call and every agent (root + children) gets them.
