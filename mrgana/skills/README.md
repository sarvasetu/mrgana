...
Skills are specialized knowledge packages that enhance Mrgana agents with deep expertise in specific vulnerability types, technologies, and testing methodologies. Each skill provides advanced techniques, practical examples, and validation methods that go beyond baseline security knowledge.
...
Community contributions are more than welcome — contribute new skills via [pull requests](https://github.com/usemrgana/mrgana/pulls) or [GitHub issues](https://github.com/usemrgana/mrgana/issues) to help expand the collection and improve extensibility for Mrgana agents.
